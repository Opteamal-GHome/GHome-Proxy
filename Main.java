...
public class Main {
	...
	public static void main(String[] args) 
	{
		...
		DevicePhysique contact = new DevicePhysique(Constantes.ID_CONTACT, "06-00-01", null);
		...
		DevicePhysique interrupteur = new DevicePhysique(Constantes.ID_INTERRUPTEUR_4, "05-02-01", null);
